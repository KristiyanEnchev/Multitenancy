namespace Multitenant.Infrastructure.Extensions.Cors
{
    using Microsoft.AspNetCore.Builder;
    using Microsoft.Extensions.Configuration;
    using Microsoft.Extensions.DependencyInjection;

    using Multitenant.Models.Cors;
    ...
    public static class CorsExtension
    {
        ...
        public static IServiceCollection AddCorsPolicy(this IServiceCollection services, IConfiguration config)
        {
            ...
            if (corsSettings.Additional is not null)
            {
                origins.AddRange(corsSettings.Additional.Split(';', StringSplitOptions.RemoveEmptyEntries));
            }
