namespace Multitenant.Host.Startup
{
    public static class ConfigurationInitializer
    {
        internal static WebApplicationBuilder AddConfigurations(this WebApplicationBuilder builder)
        {
            ...
            builder.Configuration.AddJsonFile("appsettings.json", optional: false, reloadOnChange: true)
                    ...
                    .AddJsonFile($"{configurationsDirectory}/elmah.json", optional: false, reloadOnChange: true)
                    .AddJsonFile($"{configurationsDirectory}/elmah.{env.EnvironmentName}.json", optional: true, reloadOnChange: true)
