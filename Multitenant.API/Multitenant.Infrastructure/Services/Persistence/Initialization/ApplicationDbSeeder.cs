namespace Multitenant.Infrastructure.Services.Persistence.Initialization
{
    ...
    internal class ApplicationDbSeeder
    {
        ...
        public ApplicationDbSeeder(MultiTenantInfo currentTenant, RoleManager<ApplicationRole> roleManager, UserManager<ApplicationUser> userManager, CustomSeederRunner seederRunner, ILogger<ApplicationDbSeeder> logger)
        {
