namespace Multitenant.Infrastructure.Services.Tenant.Context
{
    ...
    public abstract class BaseDbContext : MultiTenantIdentityDbContext<User, UserRole, string, IdentityUserClaim<string>, IdentityUserRole<string>, IdentityUserLogin<string>, RoleClaim, IdentityUserToken<string>>
    {
