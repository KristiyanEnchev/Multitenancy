namespace Multitenant.Application.Interfaces.Tenant
{
    ...
    public interface ITenantService
    {
        ...
        Task<string> UpdateConnectionString(UpdateConnectionStringTenantRequest request, CancellationToken cancellationToken);
